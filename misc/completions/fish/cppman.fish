...
complete -c $progname -l format -d "Output template for '--find-page', '--index', a python new-style format string which may contain {id}, {keyword}, {title}, {url}"
complete -c $progname -l id -d "Find man page by id"
